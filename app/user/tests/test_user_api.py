...
class PublicUserAPITests(TestCase):
    ...
    def test_create_valid_user_sccess(self):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@on.com', password='testtest', name='Test name')
        payload = {
            'email': 'test@on.com',
            'password': 'test',
            'name': 'Test name'
    ...
    def test_create_token_no_user(self):
        """Test that token is not created if user does not exsitis"""
        payload = {
            'email': 'test@on.com',
            'password': 'testtest',
            'name': 'Test name'
    ...
    def test_retrieve_user_unauthorised(self):
        """Test that authentication is require for users"""
